...
g++ -Wall -o S9E1 S9E1.cpp `pkg-config --cflags --libs opencv`
...
int main(void)
{
	...
	cout 	<< "Ingresa el caracter " 
				...
				<< " del password : ";
				cin >> opcion;
				user_password[i] = opcion;
	}

	cout 	<< "Ingresas lo siguiente: "
				<< user_password[0]
				<< user_password[1]
				<< user_password[2]
				<< user_password[3] << endl;

	cout << "Estas seguro de lo que ingresaste: ";
	cout << endl <<  "0 = YES, 1 = NOT" << endl;
	cin >> opcion;
	...
	if(comparacion==4) cout << "Ingresaste" << endl;
	else return -1;
